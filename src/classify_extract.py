...
def parse_args():
    ...
    parser.add_argument('--cnn_output_name', nargs='?', default='avg_pool', help='output layer name')
...
def classify_extract():
    ...
    print('Saved colors features numpy to ==> %s' % colors_path.format(args.dataset))
